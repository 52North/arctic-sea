 ...
 */
public abstract class VoidValueVisitor<
        E extends Exception> implements ValueVisitor<Void, E> {
    ...
    @Override
    public Void visit(TLVTValue value) throws E {
        _visit(value);
        return null;
    }
    ...
    @Override
    public Void visit(XmlValue<?> value) throws E {
        _visit(value);
        return null;
    }
