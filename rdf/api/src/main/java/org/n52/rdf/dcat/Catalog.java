...
import org.n52.rdf.AbstractTitleDescription;
import org.n52.rdf.RDFElement;
...
public class Catalog extends AbstractTitleDescription<Catalog> implements RDFElement, DcatRdfPrefix {
    ...
    public Catalog(Collection<Title> titles, Collection<Description> descriptions, Publisher publisher, Dataset dataset) {
        setTitles(titles);
