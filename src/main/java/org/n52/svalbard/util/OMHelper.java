...
public final class OMHelper {
    ...
    private static class ObservationTypeVisitor implements ValueVisitor<String, RuntimeException> {
        ...
        @Override
        public String visit(TLVTValue value) throws RuntimeException {
            return defaultValue();
        }

        @Override
        public String visit(CvDiscretePointCoverage value) throws RuntimeException {
            return defaultValue();
        }

        @Override
        public String visit(MultiPointCoverage value) throws RuntimeException {
            return defaultValue();
        }

        @Override
        public String visit(RectifiedGridCoverage value) throws RuntimeException {
            return defaultValue();
        }

        @Override
        public String visit(ProfileValue value) throws RuntimeException {
            return defaultValue();
        }
    }
}
